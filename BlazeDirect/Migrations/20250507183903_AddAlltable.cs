        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Patronyme = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsMale = table.Column<bool>(type: "bit", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ChurchId = table.Column<int>(type: "int", nullable: false),
                    Uid = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdFather = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdMother = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdIndividual = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FellowshipId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Churches_Fellowships_FellowshipId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarriageStartDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MarriageEndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "getdate()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonPlaceTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonPlaceTypes_People_PersonId",
                        column: x => x.PersonId,
                        principalTable: "People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonPlaceTypes_PlaceTypes_PlaceTypeId",
                        column: x => x.PlaceTypeId,
                        principalTable: "PlaceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonPlaceTypes_Places_PlaceId",
                        column: x => x.PlaceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Churches_FellowshipId",
                table: "Churches",
                column: "FellowshipId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonPlaceTypes_PersonId",
                table: "PersonPlaceTypes",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonPlaceTypes_PlaceId",
                table: "PersonPlaceTypes",
                column: "PlaceId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonPlaceTypes_PlaceTypeId",
                table: "PersonPlaceTypes",
                column: "PlaceTypeId");
